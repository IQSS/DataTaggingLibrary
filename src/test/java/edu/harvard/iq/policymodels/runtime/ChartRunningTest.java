...
import static edu.harvard.iq.policymodels.model.decisiongraph.Answer.*;
...
import edu.harvard.iq.policymodels.parser.decisiongraph.ContentReader;
import edu.harvard.iq.policymodels.parser.decisiongraph.DecisionGraphCompiler;
import edu.harvard.iq.policymodels.parser.decisiongraph.MemoryContentReader;
import edu.harvard.iq.policymodels.parser.exceptions.DataTagsParseException;
import static edu.harvard.iq.policymodels.util.CollectionHelper.*;
...
public class ChartRunningTest {
    ...
    public void chartWithCall() throws DataTagsParseException, IOException {
        String code = "[>a< todo:a][>b< todo:a][>c< call:n][>e<end][-->n< [>d< end]--]";
